            ...
            <div className="socialmediaFooterIcons">
                ...
                <ul className="example-2">
                    ...
                    {/*  <li className="icon-content">
                        <a data-social="youtube" aria-label="Youtube" href="https://www.youtube.com/@IVNOGOOD">
 ...
 */}
                    ...
                    <li className="icon-content">
                        <a data-social="github" aria-label="GitHub" href="https://github.com/Ivnogood">
                            <div className="filled"></div>
                            <svg
                                viewBox="0 0 16 16"
